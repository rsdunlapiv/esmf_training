!
! This LND model is only partially complete.
!
! By default, it receives a time step length from its parent
! Driver (15 minutes).  However, assume that the land component,
! for stability reasons, requires a smaller time step (5 min).
!
! Add the SetClock specialization to change the time step
! length to 5 minutes for this model.
!
module LND
